...
This repository contains the text for the *Tiny Python 2.7 Notebook*.
...
found in Python 2.7. It is designed to accompany technical corporate
...
This book covers the syntax in Python up to version 2.7.
